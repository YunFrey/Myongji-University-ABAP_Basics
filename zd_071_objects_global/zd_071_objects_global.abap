*&---------------------------------------------------------------------*
*& Report Z_071_OBJECTS_GLOBAL
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZD_071_OBJECTS_GLOBAL.

*INCLUDE Z_071_CLASS_INCLUDE.

*lcl_airplane 클래스를 참조하여 r_plane 변수와 인터널 테이블 생성
DATA : r_plane TYPE REF TO zcl_airplane_071,
      it_plane_list TYPE TABLE OF REF TO zcl_airplane_071.
...
CALL METHOD zcl_airplane_071=>get_no_of_planes "클래스 메소드 접근
 IMPORTING
